...
(function(){
	...
	// --------- Remote Das --------- //
	app.chainDao = brite.registerDao(new RemoteDaoHandler("Chain"));
	app.rowDao = brite.registerDao(new RemoteDaoHandler("Row"));
	app.itemDao  = brite.registerDao(new RemoteDaoHandler("Item"));
	// --------- /Remote Das --------- //
