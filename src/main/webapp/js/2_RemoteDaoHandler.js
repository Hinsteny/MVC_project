...
(function(){
	...
	RemoteDaoHandler.prototype.list = function(opts) {
		...
		var data = {};
		data.pageIndex = opts ? (opts.pageIndex || 0) : 0;
		data.pageSize = opts ? (opts.pageSize || 15) : 15;
		data.orderBy = opts ? (opts.orderBy || "id") : "id";
		data.orderType = opts ? (opts.orderType || "asc") : "asc";
		if (opts){
			if (opts.filter){
